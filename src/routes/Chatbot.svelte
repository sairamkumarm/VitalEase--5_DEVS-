	...
	let messageFeed = [
		{
			...
			message: 'Hi there 👋,Welcome to VitalCare, how may I help you',
		...
		},
		{
			...
			message:
				'To check medications, please navigate to Dashboard and scroll to the medication section',
			color: 'variant-soft-primary'
		},
		{
			id: 3,
...
<div class="container bg-transparent overflow-hidden card h-96 w-96 fixed bottom-5 right-0 mr-24 scale-90 z-[51]">
